...
class Mandatory extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->akses['akses'] == 'Y') {
            $data = [
                ...
                "submenu_active" => "mandatory-kabupaten-kota"
            ];
            $this->load->view('kabupaten/mandatory/view', $data);
        } else {
    ...
    public function load()
    {
        if ($this->akses['akses'] == 'Y') {
            ...
            foreach ($result as $r) {
                ...
                $status_apbd = $this->mquery->max_data_where('tbl_mandatory', 'st_apbd', ['tahun' => $tahun]);
                ...
                $nama_kabupaten = "<a href=" . base_url("mandatory-kabupaten-kota/detail/" . $tahun . '/' . $encrypt_id) . ">" . $r['nama_kabupaten'] . "</a>";
                $no++;
                $row = [
                    'no' => $no,
    ...
    public function detail($tahun, $encrypt_id)
    {
        ...
        $this->load->view('kabupaten/mandatory/view_detail', $data);
    }
    ...
    public function form()
    {
        ...
        if ($opsi == "add") {
            ...
            $this->load->view('kabupaten/mandatory/form_add', $data);
        } elseif ($opsi == "edit") {
            ...
            $this->load->view('kabupaten/mandatory/form_edit', $data);
        } else {
