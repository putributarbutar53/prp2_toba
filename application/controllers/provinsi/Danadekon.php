...
class Danadekon extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->akses['akses'] == 'Y') {
            ...
            $this->load->view('provinsi/danadekon/view', $data);
        } else {
    ...
    public function detail($tahun, $encrypt_id)
    {
        ...
        $this->load->view('provinsi/danadekon/view_detail', $data);
    }
    ...
    public function form()
    {
        ...
        if ($opsi == "add") {
            ...
            $this->load->view('provinsi/danadekon/form_add', $data);
        } elseif ($opsi == "edit") {
            ...
            $this->load->view('provinsi/danadekon/form_edit', $data);
        } else {
