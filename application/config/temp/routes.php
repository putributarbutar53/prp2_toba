...
$route['apbd-provinsi'] = 'publik/dashboard';
...
$route['apbd-opd-provinsi/([.0-9a-zA-Z-]+)'] = 'publik/skpd/detail/$1';

$route['dana-desa'] = 'publik/danadesa';

$route['kabupaten-kota'] = 'publik/kabupatenkota';
$route['kabupaten-kota-detail/([.0-9a-zA-Z-]+)'] = 'publik/kabupatendetail/index/$1';
$route['kabupaten-kota-detail1/([.0-9a-zA-Z-]+)'] = 'publik/kabupatendetail/khususkota/$1';

$route['mandatory-spending'] = 'publik/mandatory';
$route['lra-kabupaten-kota'] = 'upload_lra_kabupaten/lra_kabupaten';
$route['lra-kabupaten-detail/([.0-9a-zA-Z-]+)'] = 'upload_lra_kabupaten/lra_kabupaten/detail/$1';
...
$route['realisasi-keuangan/detail/([.0-9a-zA-Z-]+)'] = 'laporan/realisasi_keuangan/detail/$1';
...
$route['laporan-realisasi-keuangan/detail/([.0-9a-zA-Z-]+)'] = 'laporan/laporan_realisasi/detail/$1';
...
$route['anggaran-kas-detail/([.0-9a-zA-Z-]+)'] = 'upload_anggaran_kas/anggarankas/detail/$1';
