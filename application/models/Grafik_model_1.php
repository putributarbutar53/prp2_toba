...
class Grafik_model extends CI_Model {
    ...
    public function realisasi_pb_provinsi($tahun)
    {
        ...
        foreach ($result_skpd as $s) {
            ...
            {
                $persen_belanja=round(($row_real_belanja['realisasi']/$hsl_belanja*100),2);
            }

            if($row_real_pendapatan['realisasi']==0){$dis_real_pendapatan=0;}
            else{$dis_real_pendapatan=$row_real_pendapatan['realisasi'];}
            ...
            $row = [
                ...
                'realisasi_belanja' => $row_real_belanja['realisasi'],
        ...
        foreach ($sorting_data5 as $sort5) {
            if($sort5['dak_pagu_opd']!=0)
            {
                ...
                $real_skpd_dak .= $sort5['dak_real_opd'].",";
            }
        }
