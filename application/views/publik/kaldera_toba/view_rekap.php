<fieldset class="scheduler-border">
    <legend class="scheduler-border">Rekapitulasi Kegiatan Pengembangan Geopark Kaldera Toba </legend>
    <div class="row">
        <div class="col-md-12">
            <div class="card-body bg-primary-gradient">
                <div class="inner">
                    <h2 style="color: white; font-weight: bold;"> <i class="fa fa-chart-bar"></i> Dana Kegiatan Pengembangan Geopark Kaldera Toba</h2>
                    <div class="row">
...
<script type="text/javascript">
    $(document).ready(function() {
        barchart = new Highcharts.Chart({
            ...
            title: {
                text: 'Realisasi Dana Kegiatan Pengembangan Geopark Kaldera Toba'
            },
            subtitle: {
