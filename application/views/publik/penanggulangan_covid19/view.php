            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div id="display-content" style="display: none;">
                        <h2>Data Kegiatan Penanggulangan Covid-19</h2>
...
<script>
    ...
    function load_data_rekap() {
            ...
            $('.preload_rekap').show();
            $.ajax({
                url: '<?= site_url('publik/penanggulangan_covid19/load_rekap'); ?>',
                type: "POST",
                dataType: "html",
    ...
    function load_data() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('publik/penanggulangan_covid19/load_kegiatan'); ?>",
                type: 'POST'
            },
            columnDefs: [{
