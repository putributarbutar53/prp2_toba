<fieldset class="scheduler-border">
    <legend class="scheduler-border">Rekapitulasi Kegiatan Penanggulangan Covid-19 </legend>
    <div class="row">
        <div class="col-md-12">
            <div class="card-body bg-primary-gradient">
                <div class="inner">
                    <h2 style="color: white; font-weight: bold;"> <i class="fa fa-chart-bar"></i> Dana Kegiatan Penanggulangan Covid-19</h2>
                    <div class="row">
...
<script type="text/javascript">
    $(document).ready(function() {
        barchart = new Highcharts.Chart({
            ...
            title: {
                text: 'Realisasi Dana Kegiatan Penanggulangan Covid-19'
            },
            subtitle: {
