    ...
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
			...
			<div class="ml-sm-auto py-md-0">
                ...
                <a href="<?= site_url('kabupaten-kota') ?>" class="btn btn-danger btn-round btn-sm"></i> Kabupaten/Kota</a> 
            </div>
		</div>
    </div>
</div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <?php $this->load->view('grafik/kabupatendetail/v_anggaran_pendapatan_kota'); ?>  
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-lg-12 col-12">
                    <?php $this->load->view('grafik/kabupatendetail/v_anggaran_belanja_kota'); ?>  
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-lg-6 col-12">
                    <?php $this->load->view('grafik/kabupatendetail/v_mandatory_kota'); ?>  
                </div>
                <div class="col-lg-6 col-12">
                    <?php $this->load->view('grafik/kabupatendetail/v_mandatory_papbd_kota'); ?>  
                </div>
            </div>
...
<?php $this->load->view('grafik/kabupatendetail/js_struktur_anggaran_kota'); ?>
