...
<?php $this->load->view('beranda/js_pendapatan'); ?>
<script type="text/javascript">
    $(document).ready(function() {
        Highcharts.chart('chart-bagan', {
            ...
            title: {
                text: 'Struktur Anggaran Pendapatan Pada APBD Kota Pematangsiantar'
            },
            accessibility: {
                point: {
        ...
        var chartbar = new Highcharts.Chart({
            ...
            title: {
                text: 'Rating Anggaran Pendapatan SKPD Pada APBD Provinsi Sumatera Utara'
            },
            xAxis: {
        ...
        var chartbar = new Highcharts.Chart({
            ...
            colors: ['#337ab7', '#00c0ef'],
            title: {
                text: 'Rating Persen Realisasi Pendapatan SKPD Pada APBD Provinsi Sumatera Utara'
            },
            subtitle: {
