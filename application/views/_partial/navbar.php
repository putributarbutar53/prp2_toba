<div class="main-header">
    ...
    <div class="logo-header" data-background-color="blue">
        <a href="<?= site_url("dashboard"); ?>" class="logo">
            <img src="<?= base_url('images/preloader.png'); ?>" alt="Icon" style="width: 25px; margin-right: 5px;">
            <h3 class="navbar-brand text-white" style="font-size: 18px; font-weight: bold;">PRP2Toba</h3>
        </a>
