            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h3 class="pb-3 fw-bold"><?= $skpd['nama_skpd'] ?></h3>
                        ...
                        <a href="<?= base_url('uploads/format/Format_Laporan_Realisasi_Anggaran_LRA.xlsx') ?>" target="_blank" class="btn btn-success btn-round btn-sm mr-2 mb-3"><i class="fa fa-download"></i> Format Excel</a>
