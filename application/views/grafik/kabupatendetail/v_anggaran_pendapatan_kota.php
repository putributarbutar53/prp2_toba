<div class="card-body bg-secondary-gradient">
    <div class="inner">
        <h2 style="color: white; font-weight: bold;"><i class="fa fa-chart-bar"></i> ANGGARAN PENDAPATAN PADA APBD <?=$result_kabupaten_nama?> : <?= "Rp " . format_angka($row_pendapatan['pendapatan']); ?></h2>
        <div class="row">
            <div class="col-lg-8 col-12">
                <div id="struktur-anggaran" style="width:100%; height: 300px;"></div>
            </div>
            <div class="col-lg-4 col-12">
                <div id="alokasi-pendapatan" style="width:100%; height: 300px;"></div>
            </div>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-lg-6 col-12">
            <div id="realisasi-pendapatan" style="width:100%; height: 370px;"></div>
        </div>
        <div class="col-lg-6 col-12">
            <div class="table-responsive">
                <table class="table-grafik" style="margin-bottom: 0; width: 100%;">
                    <tr style="background-color: #FCFFC5; font-weight: bold;">
                        <td  colspan="4">Tabel Alokasi Anggaran Pendapatan Pada APBD <?=$result_kabupaten_nama?></td>
                    </tr>
            ...
            <div class="card card-info bg-info-gradient">
				<div class="card-body">
                    <div class="row">
                        <div class="col-lg-8 col-12">
                            <h4 class="mb-1 fw-bold">Realisasi Pendapatan <?=$result_kabupaten_nama?>
                                <br>Per Tanggal <?= $this->fungsi->nama_bulan($tanggal_data)?>
                                <br>Realisasi : <?= "Rp " . format_angka($pendapatan_terakhir); ?>
                                <br>Persen : <?= hitung_persen($pendapatan_terakhir,$row_pendapatan['pendapatan'],1); ?> %
                            </h4>
                        </div>
                        <div class="col-lg-4 col-12">
