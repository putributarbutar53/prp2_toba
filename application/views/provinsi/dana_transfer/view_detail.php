...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">Data Mandatory Spending <?= $row_kabupaten['nama_kabupaten'] ?> Tahun <?= $tahun; ?></h3>
        </div>
    </div>
</div>
    ...
    <div class="card full-height">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="d-flex align-items-left flex-column flex-sm-row">
                        <h3 class="pb-3 fw-bold"><?= $row_kabupaten['nama_kabupaten'] ?></h3>
                            ...
                            <table id="load-content" class="table-default" style="width: 100%;">
                                <thead>
                                    <tr style="background-color: #1572EB; color: white;">
                                        ...
                                        <th class="text-center">Penanganan Covid-19</th>
...
<?php $this->load->view('provinsi/mandatory/js_detail'); ?>
