                ...
                <div class="container clearfix">
                    ...
                    <div class="main-navigation">
                        <ul class="one-page-scroll-menu navigation-box">
                            ...
                            <li class="scrollToLink">
                                <a href="https://tobakab.go.id/">Website</a>
                            </li>
                            <li class="scrollToLink">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-8">
                        <div class="banner-one__content">
                            <h3 class="banner-one__title"><span>Aplikasi</span> <br>PRP2Toba</h3><!-- /.banner-one__title -->
                            <br>
                            <h4>Progress Report Pengendalian Pembangunan Kabupaten Toba</h4><!-- /.banner-one__title -->
                            <p class="banner-one__text">Bagian Administrasi Pembangunan <br> Setda Kabupaten Toba</p>
                            <!-- /.banner-one__text -->
            ...
            <div class="site-footer__bottom">
                <div class="container">
                    <div class="inner-container text-center">
                        <p class="site-footer__copy">&copy; copyright 2022 by <a href="#">DINAS KOMUNIKASI DAN INFORMATIKA KABUPATEN TOBA</a></p>
                        <!-- /.site-footer__copy -->
                    </div><!-- /.inner-container -->
                </div><!-- /.container -->
