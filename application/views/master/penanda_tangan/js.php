<script>
    ...
    function load_data() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('master/penanda_tangan/load'); ?>",
                type: 'POST'
            },
            columnDefs: [{
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('master/penanda_tangan/form'); ?>',
            type: "POST",
            data: {
                opsi: "add"
            },
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $.ajax({
            url: "<?= site_url('master/penanda_tangan/add'); ?>",
            type: "POST",
    ...
    $(document).on("submit", "#form-new", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('master/penanda_tangan/new_ttd'); ?>",
            type: "POST",
            enctype: 'multipart/form-data',
            data: new FormData($(form_id)[0]),
            dataType: "json",
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('master/penanda_tangan/edit'); ?>",
            type: "POST",
            enctype: 'multipart/form-data',
            data: new FormData($(form_id)[0]),
            dataType: "json",
