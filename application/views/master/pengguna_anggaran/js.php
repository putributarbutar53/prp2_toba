<script>
    ...
    function load_data() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('master/pengguna_anggaran/load'); ?>",
                type: 'POST'
            },
            columnDefs: [{
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('master/pengguna_anggaran/form'); ?>',
            type: "POST",
            data: {
                opsi: "add"
            },
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $.ajax({
            url: "<?= site_url('master/pengguna_anggaran/add'); ?>",
            type: 'POST',
    ...
    $(document).on("click", "#tombol-new", function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                $('#load-form-action').html(data);
                $(self).html('<i class="fa fa-user"></i> NEW PA');
                $(self).attr('disabled', false);
            }
        });
    });
    ...
    $(document).on("submit", "#form-new", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('master/pengguna_anggaran/new_pa'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('master/pengguna_anggaran/edit'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
