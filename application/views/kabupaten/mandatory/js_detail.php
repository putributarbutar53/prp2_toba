<script>
    ...
    function load_apbd() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('mandatory-kabupaten-kota/load_anggaran'); ?>",
                type: 'POST',
                data: {
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('mandatory-kabupaten-kota/form'); ?>',
            type: "POST",
            data: {
                opsi: "add",
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $.ajax({
            url: "<?= site_url('mandatory-kabupaten-kota/add'); ?>",
            type: 'POST',
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('mandatory-kabupaten-kota/edit'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        e.preventDefault();
        url = '<?= site_url('mandatory-kabupaten-kota/delete'); ?>';
        id = $(this).data('id');
