...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">DATA APBD <?= $row_kabupaten['nama_kabupaten'] ?> TAHUN <?= $tahun; ?></h3>
                            ...
                            <table id="load-content" class="table-default" style="width: 100%;">
                                <thead>
                                    <tr style="background-color: #1572EB; color: white;">
                                        <th width="5px">No</th>
                                        <th>Tahun</th>
                                        <th class="text-center">DBH</th>
                                        <th class="text-center">DAU</th>
                                        <th class="text-center">DAK FISIK</th>
                                        <th class="text-center">DAK NON FISIK</th>
...
<?php $this->load->view('kabupaten/tkdd/js_detail'); ?>
