<script>
    ...
    function load_data() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('tkdd-kabupaten-kota/load_detail'); ?>",
                type: 'POST',
                data: {
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('tkdd-kabupaten-kota/form_add'); ?>',
            type: "POST",
            data: {
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('tkdd-kabupaten-kota/add'); ?>",
            type: 'POST',
    ...
    $(document).on("click", "#tombol-ubah", function() {
        ...
        $.ajax({
            url: '<?= site_url('tkdd-kabupaten-kota/form_edit'); ?>',
            type: "POST",
            data: {
                id: $(this).data('id')
            },
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('tkdd-kabupaten-kota/edit'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        ...
        swal({
            ...
            if (Delete) {
                $.ajax({
                    url: '<?= site_url('tkdd-kabupaten-kota/delete'); ?>',
                    type: "POST",
                    data: {
                        id: $(this).data('id')
                    },
