    ...
    <form id="form-ubah">
        <div class="modal-body">
            <div class="form-group">
                ...
                <input type="hidden" name="id_wilayah" id="id_wilayah" class="form-control" value="<?= $tkdd['id_tkdd']; ?>" autocomplete="off" readonly>
            ...
            <div class="form-group">
                ...
                <input type="text" name="tahun" id="tahun" class="form-control" value="<?= $tkdd['tahun']; ?>" autocomplete="off" readonly>
                <small class="text-danger tahun"></small>
            </div>
            <div class="form-group">
                <label for="dbh">DBH</label>
                <input type="text" name="dbh" id="dbh" value="<?= format_rupiah($tkdd['dbh']); ?>" class="form-control" autocomplete="off">
                <small class="text-danger dbh"></small>
            </div>
            <div class="form-group">
                <label for="dau">DAU</label>
                <input type="text" name="dau" id="dau" value="<?= format_rupiah($tkdd['dau']); ?>" class="form-control" autocomplete="off">
                <small class="text-danger dau"></small>
            </div>
            <div class="form-group">
                <label for="dakfisik">DAK Fisik</label>
                <input type="text" name="dakfisik" id="dakfisik" value="<?= format_rupiah($tkdd['dakfisik']); ?>" class="form-control" autocomplete="off">
                <small class="text-danger dakfisik"></small>
            </div>
            <div class="form-group">
                <label for="daknon">DAK Non Fisik</label>
                <input type="text" name="daknon" id="daknon" value="<?= format_rupiah($tkdd['daknon']); ?>" class="form-control" autocomplete="off">
                <small class="text-danger daknon"></small>
            </div>
            <div class="form-group">
                <label for="did">DID</label>
                <input type="text" name="did" id="did" value="<?= format_rupiah($tkdd['did']); ?>" class="form-control" autocomplete="off">
                <small class="text-danger did"></small>
            </div>
            <div class="form-group">
                <label for="desa">Desa</label>
                <input type="text" name="desa" id="desa" value="<?= format_rupiah($tkdd['desa']); ?>" class="form-control" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <select name="st_apbd" id="st_apbd" class="form-control select2" style="width: 100%;">
                    <option value="0" <?php if ($tkdd['st_apbd'] == '0') {
                                            echo 'selected';
                                        } ?>>APBD</option>
                    <option value="1" <?php if ($tkdd['st_apbd'] == '1') {
                                            echo 'selected';
                                        } ?>>P APBD</option>
                </select>
