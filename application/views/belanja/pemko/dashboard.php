...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">Anggaran Belanja pada APBD Provinsi Sumatera Utara</h3>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var chartbar = new Highcharts.Chart({
            ...
            title: {
                text: 'Rating Anggaran Belanja SKPD Pada APBD Provinsi Sumatera Utara'
            },
            xAxis: {
        ...
        var chartbar = new Highcharts.Chart({
            ...
            colors: ['#337ab7', '#00c0ef'],
            title: {
                text: 'Rating Persen Realisasi Belanja SKPD pada APBD Provinsi Sumatera Utara'
            },
            subtitle: {
