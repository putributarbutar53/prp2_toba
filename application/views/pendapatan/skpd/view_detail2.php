...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">Data Realisasi Pendapatan Pada APBD <?= $skpd['nama_skpd'] ?> periode 1 Januari <?=$tahun?> s.d <?=$nama_periode?></h3>
        </div>
    </div>
</div>
...
<?php $this->load->view('pendapatan/skpd/js_detail2'); ?>
