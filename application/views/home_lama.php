                ...
                <div class="container clearfix">
                    ...
                    <div class="main-navigation">
                        <ul class="one-page-scroll-menu navigation-box">
                            ...
                            <li class="scrollToLink">
                                <a href="http://prp2sumut.sumutprov.go.id/apbd-provinsi">Provinsi</a>
                            </li>
                            <li class="scrollToLink">
                                <a href="<?= base_url('login')?>">Kabupaten/Kota</a>
                            </li>
                        </ul>
                    </div><!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-8">
                        <div class="banner-one__content">
                            ...
                            <h3 class="banner-one__title"><span>Aplikasi</span> Progress Report Pengendalian Pembangunan Sumut</h3><!-- /.banner-one__title -->
                            <p class="banner-one__text">Biro Administrasi Pembangunan <br> Pemerintah Provinsi Sumatera Utara</p>
                            <!-- /.banner-one__text -->
        ...
        <section class="service-one" id="features">
            <div class="container">
                <div class="block-title text-center">
                    <h2 class="block-title__title">Lihat Fitur</h2><!-- /.block-title__title -->
                </div><!-- /.block-title -->
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="service-one__inner">
                                        <?php 
                                            $ch = curl_init(); 
                                            curl_setopt($ch, CURLOPT_URL, "http://localhost/prp2sumut/publik/dashboardcurl");
                                            curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1); 
                                            $output = curl_exec($ch); 
                                            curl_close($ch);      
                                            echo $output;
                                        ?>
                                        <p>Sistem Informasi Pengendalian Fisik Kegiatan
                                            Pemerintah Provinsi Sumatera Utara</p>
                                        <a href="<?= base_url()?>" class="service-one__link"> Buka Aplikasi <i class="dimon-icon-right-arrow"></i></a>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInDown" data-wow-duration="1500ms">
                        <div class="service-one__single text-center">
                            <div class="service-one__inner">
                                ...
                                <p>Sistem Informasi Evaluasi dan Pelaporan
                                    Pemerintah Provinsi Sumatera Utara</p>
                                <a href="<?= base_url()?>" class="service-one__link"> Buka Aplikasi <i class="dimon-icon-right-arrow"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInDown" data-wow-duration="1500ms">
                        <div class="service-one__single text-center">
                            <div class="service-one__inner">
                                ...
                                <p>Halaman Pengaduan Pembangunan
                                    <br>Pemerintah Provinsi Sumatera Utara</p>
                                <a href="<?= base_url()?>" class="service-one__link"> Buka Aplikasi <i class="dimon-icon-right-arrow"></i></a>
                            </div><!-- /.service-one__inner -->
                        </div><!-- /.service-one__single -->
                    </div><!-- /.col-lg-3 col-md-6 col-sm-12 -->
