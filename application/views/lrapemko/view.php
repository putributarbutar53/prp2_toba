...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold"></h3>
        </div>
    </div>
</div>
                ...
                <div class="col-sm-12">
                    <div class="d-flex align-items-left flex-column flex-sm-row">
                        <div class="ml-sm-auto py-md-0">
                            <button id="tombol-tambah" class="btn btn-warning btn-round btn-sm mr-2 mb-3" data-toggle="modal" data-target="#modal-form-action">Upload Excel</button>
                        </div>
                    </div>
...
<?php $this->load->view('lrapemko/js'); ?>
